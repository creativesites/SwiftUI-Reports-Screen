...
public struct Colors {
    ...
    public static let GradientUpperBlue:Color = Color(.clear)
    public static let GradinetUpperBlue1:Color = Color(hexString: "#A8E1FF")
    public static let GradientPurple:Color = Color(#colorLiteral(red: 0.20392157137393951, green: 0.8156862854957581, blue: 0.7215686440467834, alpha: 1))
    public static let GradientNeonBlue:Color = Color(#colorLiteral(red: 0.20392157137393951, green: 0.8156862854957581, blue: 0.7215686440467834, alpha: 1))
    public static let GradientLowerBlue:Color = Color(#colorLiteral(red: 0.19, green: 0.19, blue: 0.19, alpha: 1))
...
public struct Styles {
    public static let lineChartStyleOne = ChartStyle(
        ...
        accentColor: Color(#colorLiteral(red: 0.19, green: 0.19, blue: 0.19, alpha: 1)),
        secondGradientColor: Color(#colorLiteral(red: 0.19, green: 0.19, blue: 0.19, alpha: 1)),
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
    public static let lineChartStyleP = ChartStyle(
        backgroundColor: Color.white,
